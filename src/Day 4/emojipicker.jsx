...
/**
 * EmojiPicker component allows users to select emojis and insert them into a textarea.
 * It displays a picker with a list of emojis and tracks frequently used emojis for quick access.
 *
 * @component
 * @example
 * <EmojiPicker />
 *
 * @returns {JSX.Element} The rendered emoji picker component.
 */
